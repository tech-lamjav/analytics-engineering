...
| **S2** | Premissas — **Gols (Over/Under)** | mercado | 5 | **§12.2** — Over (7, Σ56) + Under (6, Σ52) espelhados; pen. `linha_extrema`; xG só Brasileirão | pendente |
| **S3** | Premissas — **Handicap asiático** | mercado | 4 | **§12.3** — Favorito (5, Σ40) + Azarão (3, Σ30), pareável por `line_value`; pen. `handicap_alto` | pendente |
| **S4** | Premissas — **Ambos marcam (BTTS)** | mercado | 8 | **§12.4** — Sim (4, Σ34) + Não (3, Σ28) | pendente |
...
8. **Possível dupla contagem de movimento de linha (O/U)** — o playbook dá tanto a premissa `linha_subindo`/`linha_descendo` (+6, §12.2) **quanto** a corroboração global `linha_sharp_confirma` (+8). Se ambas medirem "Pinnacle moveu pro nosso lado", um Over com linha caindo ganha +14 só de movimento. **Decidir** na implementação: empilhar de propósito ou medir em fontes diferentes (premissa = qualquer casa; corroboração = só Pinnacle) pra não somar o mesmo sinal duas vezes.
