...
{#- AE#153 (Entrega 2 da #147/#148, ADR 0014): `insumo_escopo`/`insumo_recorte` carimbam,
    ...
    mesmo `insumos_medidos` (o array por premissa) ficando só no ramo do 1X2 nesta
    entrega. -#}
...
cand_1x2 AS (
    SELECT
        ...
        -- AE#153: o único dos cinco ramos com o array de verdade nesta entrega — os
        -- outros publicam [] (array vazio; NULL não sobrevive à escrita no BigQuery,
...
cand_ah AS (
    SELECT
        ...
        -- AE#153: array só no 1X2 nesta entrega — o modelo de Handicap ainda não tem a coluna.
        -- ⚠️ [] explícito, não CAST(NULL ...): array NULL não sobrevive à escrita no
        -- BigQuery (volta como [] — ver ⚠️ em macros/premissas_valores_medidos.sql).
        {{ futebol_insumos_medidos_vazio() }} AS insumos_medidos,
        '{{ eixos.escopo }}'                            AS insumo_escopo,
