...
WITH declarado AS (
    SELECT * FROM UNNEST([
        ...
        STRUCT('int_futebol_premissas_ou' AS modelo, 'linha_subindo' AS nome, 'premissa' AS tipo, 2 AS n_insumos),
        ...
        STRUCT('int_futebol_premissas_ou' AS modelo, 'linha_descendo' AS nome, 'premissa' AS tipo, 2 AS n_insumos),
