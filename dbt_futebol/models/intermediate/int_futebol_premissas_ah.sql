...
metrics AS (
    SELECT
        ...
        -- ⚠️ AE#204: o `odds_linha_zero` diz se o HOME tem a menor odd, e o veredito é do
        -- OUTCOME — S é favorito quando esse fato coincide com S ser o mandante. Até a #204
        -- a comparação faltava e o Away herdava o veredito do Home (par favorito/favorito ou
        -- azarão/azarão). `NULL = x` é NULL, então sem odd o COALESCE ainda cai no mando.
        (o.side_handicap < 0
            OR (o.side_handicap = 0
                AND COALESCE(olz.home_e_favorito_por_odd = o.s_is_home, o.s_is_home)))     AS is_favorito,
        (o.side_handicap > 0
            OR (o.side_handicap = 0
                AND NOT COALESCE(olz.home_e_favorito_por_odd = o.s_is_home, o.s_is_home))) AS is_azarao,
